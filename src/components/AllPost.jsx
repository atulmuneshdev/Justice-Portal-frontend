...
const AllPost = ({ post, onUpdate }) => {
    ...
    return (
        <motion.div
            ...
            className="bg-white  rounded-2xl shadow-sm border border-gray-100 mb-6 overflow-hidden hover:shadow-md transition-shadow duration-300 h-100 w-100 mb-3"
        >
            {/* Header */}
            ...
            <div className="px-1 sm:px-2 py-1 flex items-center gap-0.5 sm:gap-1">
                <PostActionButton
                    onClick={handleLike}
                    icon={<ThumbsUp className={`w-4 h-4 sm:w-[10px] sm:h-[18px] transition-transform ${isLiked ? 'text-blue-600 fill-blue-600 scale-110' : 'group-hover:scale-110'}`} />}
                    label="Like"
                    isActive={isLiked}
                ...
                <PostActionButton
                    ...
                    icon={<MessageCircle className="w-4 h-4 sm:w-[10px] sm:h-[18px] group-hover:scale-110 transition-transform" />}
                    label="Comment"
                    isActive={showComments}
                    activeClass="text-indigo-600 bg-indigo-50/50"
                />
                <PostActionButton
                    icon={<Share2 className="w-4 h-4 sm:w-[10px] sm:h-[18px] group-hover:scale-110 transition-transform" />}
                    label="Share"
                />
                <PostActionButton
                    icon={<Send className="w-4 h-4 sm:w-[10px] sm:h-[18px] group-hover:scale-110 transition-transform" />}
                    label="Send"
                />
            </div>
